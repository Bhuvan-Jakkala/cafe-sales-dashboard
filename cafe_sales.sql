...
-- DAILY SALES, QUANTITY & ORDERS (CALENDAR TABLE)
SELECT
...
-- SAME QUERY WITH ROUNDED VALUES IN 'K'
SELECT 
...
FROM coffee_shop_sales
WHERE 
    DAYOFWEEK(transaction_date) = 3  -- Tuesday
    AND HOUR(transaction_time) = 8  -- 8 AM
    AND MONTH(transaction_date) = 5;

-- SALES FROM MONDAY TO SUNDAY FOR MAY
SELECT 
    CASE 
